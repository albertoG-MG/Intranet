...
$table_data->get('serverside_user_admin','id',array('id', 'username','usnom','apellido_pat','apellido_mat', 'correo', 'roles_id', 'foto', 'rolnom', 'depa_id', 'depanom'));
...
$table_data->get('serverside_user_vistausuarios','id',array('id', 'username','usnom','apellido_pat','apellido_mat', 'correo', 'roles_id', 'foto', 'rolnom', 'depa_id', 'depanom'));
...
$table_data->get('serverside_user_vistatecnicos','id',array('id', 'username','usnom','apellido_pat','apellido_mat', 'correo', 'roles_id', 'foto', 'rolnom', 'depa_id', 'depanom'));
}
?>