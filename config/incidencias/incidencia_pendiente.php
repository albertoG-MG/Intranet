...
if($fetch_rol_dep -> rolnom == "Superadministrador" || $fetch_rol_dep -> rolnom == "Administrador" || $fetch_rol_dep -> rolnom == "Director general" || $fetch_rol_dep -> rolnom == "Gerente" && $fetch_rol_dep -> depanom == "Recursos humanos" || $fetch_rol_dep -> rolnom == "Gerente" && $fetch_rol_dep -> depanom == "Finanzas"){
    $consulta = "SELECT incidencias.id as incidenciaid, usuarios.nombre as nombre, usuarios.apellido_pat as apellido_pat, usuarios.apellido_mat as apellido_mat, incidencias.tipo_incidencia as tipo_incidencia, incidencias.fecha_inicio as fecha_inicio, incidencias.fecha_fin as fecha_fin, estatus_incidencia.nombre as estatus_nombre FROM incidencias INNER JOIN usuarios ON incidencias.users_id = usuarios.id INNER JOIN estatus_incidencia ON incidencias.estatus_id=estatus_incidencia.id WHERE estatus_incidencia.id=:estatus";
