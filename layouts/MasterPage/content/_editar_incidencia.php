            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5 mx-7 items-start">
              <div class="grid grid-cols-1">
                ...
                <div class="group flex">
                  ...
                  <input class="w-full -ml-10 pl-10 py-2 px-3 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent" type="date" id="fechainicio" name="fechainicio" value="<?php echo "{$edit->fecha_inicio}"; ?>" onchange="rdfechafin()" onkeydown="return false" min="<?php echo "{$edit->incidencia_creada}"; ?>" data-msg-min="Por favor, ingrese una fecha mayor o igual que <?php echo "{$edit->incidencia_creada}"; ?>">
                </div>
              </div>
              <div class="grid grid-cols-1">
                ...
                <div class="group flex">
                  <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-calendar-range text-gray-400 text-lg"></i></div>
                  <input class="w-full -ml-10 pl-10 py-2 px-3 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent" type="date" id="fechafin" name="fechafin" value="<?php echo "{$edit->fecha_fin}"; ?>" onkeydown="return false" min="<?php echo "{$edit->fecha_inicio}"; ?>" data-msg-min="Por favor, ingrese una fecha mayor o igual que <?php echo "{$edit->fecha_inicio}"; ?>">
                </div>
              </div>
            </div>
