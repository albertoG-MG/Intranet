                                 ...
                                 <table class="min-w-full border-collapse block md:table">
                                    ...
                                    <tbody class="block md:table-row-group">
                                       <?php foreach ($papeleria as $fetchtipopapeleria) { ?>
                                          ...
                                          if($fetchtipopapeleria['id'] == 1 || $fetchtipopapeleria['id'] == 3 || $fetchtipopapeleria['id'] == 4 || $fetchtipopapeleria['id'] == 5 || $fetchtipopapeleria['id'] == 6 || $fetchtipopapeleria['id'] == 8 || $fetchtipopapeleria['id'] == 9 || $fetchtipopapeleria['id'] == 10){
