                           ...
                           <div class="block bg-transparent rounded-lg tab-pane" id="datosG" role="tabpanel" aria-labelledby="datosG-tab">
                              ...
                              <div class="grid grid-cols-1 mt-5 mx-7">
                                 ...
                                 <div class="group flex">
                                    ...
                                    <input class="w-full -ml-10 pl-10 py-2 h-11 border rounded-md border-[#d1d5db] focus:ring-2 focus:ring-indigo-600" type="text" aria-describedby="numempleado_help" id="numempleado" name="numempleado" value="<?php echo "{$edit->enum_empleado}"; ?>" placeholder="i.e. L-35">
                                 </div>
                              ...
                              <div class="grid grid-cols-1 mt-5 mx-7">
                                 ...
                                 <div class="group flex">
                                    ...
                                    <input class="w-full -ml-10 pl-10 py-2 h-11 border rounded-md border-[#d1d5db] focus:ring-2 focus:ring-indigo-600" type="text" id="puesto" name="puesto" value="<?php echo "{$edit->epuesto}"; ?>" placeholder="Puesto">
                                 </div>
                              </div>
                              <div class="grid grid-cols-1 mt-5 mx-7">
                                    ...
                                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-5 md:gap-8 mt-5 mx-7 items-start">
                                       <div class="grid grid-cols-1">
                                          ...
                                          <div class="group flex">
                                             ...
                                             <input class="w-full -ml-10 pl-10 py-2 h-11 border rounded-md border-[#d1d5db] focus:ring-2 focus:ring-indigo-600" type="text" id="marcacion" name="marcacion" value="<?php if($edit->eposee_telempresa == 'si'){ echo $edit->emarcacion; } ?>" placeholder="i.e. 767">
                                          </div>
                                       </div>
                                       <div class="grid grid-cols-1">
                                          ...
                                          <div class="group flex">
                                             ...
                                             <input class="w-full -ml-10 pl-10 py-2 h-11 border rounded-md border-[#d1d5db] focus:ring-2 focus:ring-indigo-600" type="text" id="serie" name="serie" value="<?php if($edit->eposee_telempresa == 'si'){ echo $edit->eserie; } ?>" placeholder="i.e. DB168091200530">
                                          </div>
                                       </div>
                                       <div class="grid grid-cols-1">
                                          ...
                                          <div class="group flex">
                                             ...
                                             <input class="w-full -ml-10 pl-10 py-2 h-11 border rounded-md border-[#d1d5db] focus:ring-2 focus:ring-indigo-600" type="text" id="sim" name="sim" value="<?php if($edit->eposee_telempresa == 'si'){ echo $edit->esim; } ?>" placeholder="i.e 89014103211118510720">
                                          </div>
                                       </div>
                                    </div>
                                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-5 md:gap-8 mt-5 mx-7 items-start">
                                       <div class="grid grid-cols-1">
                                          ...
                                          <div class="group flex">
                                             ...
                                             <input class="w-full -ml-10 pl-10 py-2 h-11 border rounded-md border-[#d1d5db] focus:ring-2 focus:ring-indigo-600" type="text" id="numred" name="numred" value="<?php if($edit->eposee_telempresa == 'si'){ echo $edit->enumred; } ?>" placeholder="i.e. 310260">
                                          </div>
                                       </div>
                                       <div class="grid grid-cols-1">
                                          ...
                                          <div class="group flex">
                                             ...
                                             <input class="w-full -ml-10 pl-10 py-2 h-11 border rounded-md border-[#d1d5db] focus:ring-2 focus:ring-indigo-600" type="text" id="modelotel" name="modelotel" value="<?php if($edit->eposee_telempresa == 'si'){ echo $edit->modeltel; } ?>" placeholder="i.e. TP802A">
                                          </div>
                                       </div>
                                       <div class="grid grid-cols-1">
                                          ...
                                          <div class="group flex">
                                             ...
                                             <input class="w-full -ml-10 pl-10 py-2 h-11 border rounded-md border-[#d1d5db] focus:ring-2 focus:ring-indigo-600" type="text" id="marcatel" name="marcatel" value="<?php if($edit->eposee_telempresa == 'si'){ echo $edit->marcatel; } ?>" placeholder="i.e. Samsung Galaxy">
                                          </div>
                                       </div>
                                    </div>
                                    <div class="grid grid-cols-1 mt-5 mx-7">
                                       ...
                                       <div class="group flex">
                                          ...
                                          <input class="w-full -ml-10 pl-10 py-2 h-11 border rounded-md border-[#d1d5db] focus:ring-2 focus:ring-indigo-600" type="text" id="imei" name="imei" value="<?php if($edit->eposee_telempresa == 'si'){ echo $edit->eimei; } ?>" placeholder="i.e. 861536030196001">
                                       </div>
                                    </div>
                                 </div>
                              </div>
                                    ...
                                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-5 md:gap-8 mt-5 mx-7 items-start">
                                       <div class="grid grid-cols-1">
                                          ...
                                          <div class="group flex">
                                             ...
                                             <input class="w-full -ml-10 pl-10 py-2 h-11 border rounded-md border-[#d1d5db] focus:ring-2 focus:ring-indigo-600" type="text" id="marca_laptop" name="marca_laptop" value="<?php if($edit->eposee_laptop == 'si'){ echo $edit->emarca_laptop; } ?>"  placeholder="i.e. Lenovo">
                                          </div>
                                       </div>
                                       <div class="grid grid-cols-1">
                                          ...
                                          <div class="group flex">
                                             ...
                                             <input class="w-full -ml-10 pl-10 py-2 h-11 border rounded-md border-[#d1d5db] focus:ring-2 focus:ring-indigo-600" type="text" id="modelo_laptop" name="modelo_laptop" value="<?php if($edit->eposee_laptop == 'si'){ echo $edit->emodelo_laptop; } ?>" placeholder="i.e. Lenovo Ideapad 330-15ARR">
                                          </div>
                                       </div>
                                       <div class="grid grid-cols-1">
                                          ...
                                          <div class="group flex">
                                             ...
                                             <input class="w-full -ml-10 pl-10 py-2 h-11 border rounded-md border-[#d1d5db] focus:ring-2 focus:ring-indigo-600" type="text" id="serie_laptop" name="serie_laptop" value="<?php if($edit->eposee_laptop == 'si'){ echo $edit->eserie_laptop; } ?>" placeholder="i.e. S100NWDJ">
                                          </div>
                                       </div>
                                    </div>
                                 </div>
                              ...
                              <div class="grid grid-cols-1 lg:grid-cols-2 gap-5 md:gap-8 mt-5 mx-7 items-start">
                                 <div class="grid grid-cols-1">
                                    ...
                                    <div class="group flex">
                                       ...
                                       <input class="w-full -ml-10 pl-10 py-2 h-11 border rounded-md border-[#d1d5db] focus:ring-2 focus:ring-indigo-600" type="text" id="salario_contrato" name="salario_contrato" value="<?php echo "{$edit -> esalario_contrato}"; ?>" placeholder="Salario al inicio del periodo de prueba">
                                    </div>
                                 </div>
                                 <div class="grid grid-cols-1">
                                    ...
                                    <div class="group flex">
                                       ...
                                       <input class="w-full -ml-10 pl-10 py-2 h-11 border rounded-md border-[#d1d5db] focus:ring-2 focus:ring-indigo-600" type="text" id="salario_fechaalta" name="salario_fechaalta" value="<?php echo "{$edit -> esalario_fechaalta}"; ?>" placeholder="Salario después del periodo de prueba">
                                    </div>
                                 </div>
                              </div>
                              <div class="grid grid-cols-1 mt-5 mx-7">
                                 <label class="text-[#64748b] font-semibold mb-2">Observaciones</label>
                                 <textarea class="w-full py-2 h-20 border rounded-md border-[#d1d5db] focus:ring-2 focus:ring-indigo-600" id="observaciones" name="observaciones" placeholder="Observaciones"><?php echo "{$edit->eobservaciones}"; ?></textarea>
                              ...
                              <div class="grid grid-cols-1 lg:grid-cols-3 gap-5 md:gap-8 mt-5 mx-7 items-start">
                                 <div class="grid grid-cols-1">
                                    ...
                                    <div class="group flex">
                                       ...
                                       <input class="w-full -ml-10 pl-10 py-2 h-11 border rounded-md border-[#d1d5db] focus:ring-2 focus:ring-indigo-600" type="text" id="banco_nomina" name="banco_nomina" value="<?php echo "{$edit -> ebanco_nomina}"; ?>" placeholder="Banco">
                                    </div>
                                 </div>
                                 <div class="grid grid-cols-1">
                                    <label class="text-[#64748b] font-semibold mb-2">Cuenta</label>
                                    <div class="group flex">
                                       ...
                                       <input class="w-full -ml-10 pl-10 py-2 h-11 border rounded-md border-[#d1d5db] focus:ring-2 focus:ring-indigo-600" type="text" id="cuenta_nomina" name="cuenta_nomina" value="<?php echo "{$edit -> ecuenta_nomina}"; ?>" placeholder="Cuenta">
                                    </div>
                                 </div>
                                 <div class="grid grid-cols-1">
                                    <label class="text-[#64748b] font-semibold mb-2">Clabe</label>
                                    <div class="group flex">
                                       ...
                                       <input class="w-full -ml-10 pl-10 py-2 h-11 border rounded-md border-[#d1d5db] focus:ring-2 focus:ring-indigo-600" type="text" id="clabe_nomina" name="clabe_nomina" value="<?php echo "{$edit -> eclabe_nomina}"; ?>" placeholder="Clabe">
                                    </div>
                                 </div>
                                 <div class="grid grid-cols-1 lg:col-span-3">
                                    ...
                                    <div class="group flex">
                                       ...
                                       <input class="w-full -ml-10 pl-10 py-2 h-11 border rounded-md border-[#d1d5db] focus:ring-2 focus:ring-indigo-600" type="text" id="plastico" name="plastico" value="<?php echo "{$edit -> eplastico}"; ?>" placeholder="Plástico asignado">
                                    </div>
                                 </div>
                              </div>
                              <div class="mt-12 h-px bg-slate-200"></div>
