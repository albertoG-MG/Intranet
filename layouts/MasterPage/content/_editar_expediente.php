                                    ...
                                    <table class="min-w-full border-collapse block md:table">
                                        <thead class="block md:table-header-group">
                                            <tr class="border border-grey-500 md:border-none block md:table-row absolute -top-full md:top-auto -left-full md:left-auto  md:relative ">
                                                ...
                                                <th class="bg-gray-600 p-2 text-white font-bold md:border md:border-grey-500 text-left block md:table-cell">Descarga</th>
                                        ...
                                        <tbody class="block md:table-row-group">
                                            ...
                                            <tr class="bg-gray-300 border border-grey-500 md:border-none block md:table-row">
                                                <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span class="inline-block w-full md:hidden font-bold">id</span>1</td>
                                                <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span class="inline-block w-full md:hidden font-bold">Nombre</span>Curriculum y/o solicitud</td>
                                            ...
                                            <tr class="bg-white border border-grey-500 md:border-none block md:table-row">
                                                <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span class="inline-block w-full md:hidden font-bold">id</span>2</td>
                                                <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span class="inline-block w-full md:hidden font-bold">Nombre</span>Evaluación psicométrica</td>
                                                <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span class="inline-block w-full md:hidden font-bold">Descarga</span><?php if($array3[$contador_array3]['nombre_archivo'] != null){ ?><a class='text-blue-600 hover:border-b-2 hover:border-blue-600' download='pdfTitle' href='<?php if($array3[$contador_array3]['nombre_archivo'] != null){ echo $array3[$contador_array3]['archivo']; }else { echo '#';} ?>' title='Download pdf document'><?php echo $array3[$contador_array3]['nombre_archivo']; ?></a><?php }else{ echo "No se encontró el archivo en la base de datos";  }?> </td>
                                                <td width="70%" class="p-2 md:border md:border-grey-500 text-left block md:table-cell">
                                                    <span class="inline-block w-1/3 md:hidden font-bold">Acción</span>
                                            ...
                                            ?>
                                            <tr class="bg-gray-300 border border-grey-500 md:border-none block md:table-row">
                                                <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span class="inline-block w-full md:hidden font-bold">id</span>3</td>
                                                <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span class="inline-block w-full md:hidden font-bold">Nombre</span>Copia acta de nacimiento</td>
                                                <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span class="inline-block w-full md:hidden font-bold">Descarga</span><?php if($array3[$contador_array3]['nombre_archivo'] != null){ ?><a class='text-blue-600 hover:border-b-2 hover:border-blue-600' download='pdfTitle' href='<?php if($array3[$contador_array3]['nombre_archivo'] != null){ echo $array3[$contador_array3]['archivo']; }else { echo '#';} ?>' title='Download pdf document'><?php echo $array3[$contador_array3]['nombre_archivo']; ?></a><?php }else{ echo "No se encontró el archivo en la base de datos";  }?> </td>
                                                <td width="70%" class="p-2 md:border md:border-grey-500 text-left block md:table-cell">
                                                    <span class="inline-block w-1/3 md:hidden font-bold">Acción</span>
                                            ...
                                            ?>
                                            <tr class="bg-white border border-grey-500 md:border-none block md:table-row">
                                                <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span class="inline-block w-full md:hidden font-bold">id</span>4</td>
                                                <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span class="inline-block w-full md:hidden font-bold">Nombre</span>Curp</td>
                                                <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span class="inline-block w-full md:hidden font-bold">Descarga</span><?php if($array3[$contador_array3]['nombre_archivo'] != null){ ?><a class='text-blue-600 hover:border-b-2 hover:border-blue-600' download='pdfTitle' href='<?php if($array3[$contador_array3]['nombre_archivo'] != null){ echo $array3[$contador_array3]['archivo']; }else { echo '#';} ?>' title='Download pdf document'><?php echo $array3[$contador_array3]['nombre_archivo']; ?></a><?php }else{ echo "No se encontró el archivo en la base de datos";  }?> </td>
                                                <td width="70%" class="p-2 md:border md:border-grey-500 text-left block md:table-cell">
                                                    <span class="inline-block w-1/3 md:hidden font-bold">Acción</span>
                                            ...
                                            ?>
                                            <tr class="bg-gray-300 border border-grey-500 md:border-none block md:table-row">
                                                <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span class="inline-block w-full md:hidden font-bold">id</span>5</td>
                                                <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span class="inline-block w-full md:hidden font-bold">Nombre</span>Identificación oficial</td>
                                                <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span class="inline-block w-full md:hidden font-bold">Descarga</span><?php if($array3[$contador_array3]['nombre_archivo'] != null){ ?><a class='text-blue-600 hover:border-b-2 hover:border-blue-600' download='pdfTitle' href='<?php if($array3[$contador_array3]['nombre_archivo'] != null){ echo $array3[$contador_array3]['archivo']; }else { echo '#';} ?>' title='Download pdf document'><?php echo $array3[$contador_array3]['nombre_archivo']; ?></a><?php }else{ echo "No se encontró el archivo en la base de datos";  }?> </td>
                                                <td width="70%" class="p-2 md:border md:border-grey-500 text-left block md:table-cell">
                                                    <span class="inline-block w-1/3 md:hidden font-bold">Acción</span>
                                            ...
                                            ?>
                                            <tr class="bg-white border border-grey-500 md:border-none block md:table-row">
                                                <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span class="inline-block w-full md:hidden font-bold">id</span>6</td>
                                                <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span class="inline-block w-full md:hidden font-bold">Nombre</span>Comprobante de domicilio</td>
                                                <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span class="inline-block w-full md:hidden font-bold">Descarga</span><?php if($array3[$contador_array3]['nombre_archivo'] != null){ ?><a class='text-blue-600 hover:border-b-2 hover:border-blue-600' download='pdfTitle' href='<?php if($array3[$contador_array3]['nombre_archivo'] != null){ echo $array3[$contador_array3]['archivo']; }else { echo '#';} ?>' title='Download pdf document'><?php echo $array3[$contador_array3]['nombre_archivo']; ?></a><?php }else{ echo "No se encontró el archivo en la base de datos";  }?> </td>
                                                <td width="70%" class="p-2 md:border md:border-grey-500 text-left block md:table-cell">
                                                    <span class="inline-block w-1/3 md:hidden font-bold">Acción</span>
                                            ...
                                            ?>
                                            <tr class="bg-gray-300 border border-grey-500 md:border-none block md:table-row">
                                                <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span class="inline-block w-full md:hidden font-bold">id</span>7</td>
                                                <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span class="inline-block w-full md:hidden font-bold">Nombre</span>RFC</td>
                                                <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span class="inline-block w-full md:hidden font-bold">Descarga</span><?php if($array3[$contador_array3]['nombre_archivo'] != null){ ?><a class='text-blue-600 hover:border-b-2 hover:border-blue-600' download='pdfTitle' href='<?php if($array3[$contador_array3]['nombre_archivo'] != null){ echo $array3[$contador_array3]['archivo']; }else { echo '#';} ?>' title='Download pdf document'><?php echo $array3[$contador_array3]['nombre_archivo']; ?></a><?php }else{ echo "No se encontró el archivo en la base de datos";  }?> </td>
                                                <td width="70%" class="p-2 md:border md:border-grey-500 text-left block md:table-cell">
                                                    <span class="inline-block w-1/3 md:hidden font-bold">Acción</span>
                                            ...
                                            ?>
                                            <tr class="bg-white border border-grey-500 md:border-none block md:table-row">
                                                <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span class="inline-block w-full md:hidden font-bold">id</span>8</td>
                                                <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span class="inline-block w-full md:hidden font-bold">Nombre</span>Carta de recomendación laboral</td>
                                                <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span class="inline-block w-full md:hidden font-bold">Descarga</span><?php if($array3[$contador_array3]['nombre_archivo'] != null){ ?><a class='text-blue-600 hover:border-b-2 hover:border-blue-600' download='pdfTitle' href='<?php if($array3[$contador_array3]['nombre_archivo'] != null){ echo $array3[$contador_array3]['archivo']; }else { echo '#';} ?>' title='Download pdf document'><?php echo $array3[$contador_array3]['nombre_archivo']; ?></a><?php }else{ echo "No se encontró el archivo en la base de datos";  }?> </td>
                                                <td width="70%" class="p-2 md:border md:border-grey-500 text-left block md:table-cell">
                                                    <span class="inline-block w-1/3 md:hidden font-bold">Acción</span>
                                            ...
                                            ?>
                                            <tr class="bg-gray-300 border border-grey-500 md:border-none block md:table-row">
                                                <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span class="inline-block w-full md:hidden font-bold">id</span>9</td>
                                                <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span class="inline-block w-full md:hidden font-bold">Nombre</span>Carta de recomendación personal</td>
                                                <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span class="inline-block w-full md:hidden font-bold">Descarga</span><?php if($array3[$contador_array3]['nombre_archivo'] != null){ ?><a class='text-blue-600 hover:border-b-2 hover:border-blue-600' download='pdfTitle' href='<?php if($array3[$contador_array3]['nombre_archivo'] != null){ echo $array3[$contador_array3]['archivo']; }else { echo '#';} ?>' title='Download pdf document'><?php echo $array3[$contador_array3]['nombre_archivo']; ?></a><?php }else{ echo "No se encontró el archivo en la base de datos";  }?> </td>
                                                <td width="70%" class="p-2 md:border md:border-grey-500 text-left block md:table-cell">
                                                    <span class="inline-block w-1/3 md:hidden font-bold">Acción</span>
                                            ...
                                            ?>
                                            <tr class="bg-white border border-grey-500 md:border-none block md:table-row">
                                                <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span class="inline-block w-full md:hidden font-bold">id</span>10</td>
                                                <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span class="inline-block w-full md:hidden font-bold">Nombre</span>Aviso de retención crédito infonavit</td>
                                                <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span class="inline-block w-full md:hidden font-bold">Descarga</span><?php if($array3[$contador_array3]['nombre_archivo'] != null){ ?><a class='text-blue-600 hover:border-b-2 hover:border-blue-600' download='pdfTitle' href='<?php if($array3[$contador_array3]['nombre_archivo'] != null){ echo $array3[$contador_array3]['archivo']; }else { echo '#';} ?>' title='Download pdf document'><?php echo $array3[$contador_array3]['nombre_archivo']; ?></a><?php }else{ echo "No se encontró el archivo en la base de datos";  }?> </td>
                                                <td width="70%" class="p-2 md:border md:border-grey-500 text-left block md:table-cell">
                                                    <span class="inline-block w-1/3 md:hidden font-bold">Acción</span>
                                            ...
                                            ?>
                                            <tr class="bg-white border border-grey-500 md:border-none block md:table-row">
                                                <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span class="inline-block w-full md:hidden font-bold">id</span>12</td>
                                                <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span class="inline-block w-full md:hidden font-bold">Nombre</span>Alta del IMSS</td>
                                                <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span class="inline-block w-full md:hidden font-bold">Descarga</span><?php if($array3[$contador_array3]['nombre_archivo'] != null){ ?><a class='text-blue-600 hover:border-b-2 hover:border-blue-600' download='pdfTitle' href='<?php if($array3[$contador_array3]['nombre_archivo'] != null){ echo $array3[$contador_array3]['archivo']; }else { echo '#';} ?>' title='Download pdf document'><?php echo $array3[$contador_array3]['nombre_archivo']; ?></a><?php }else{ echo "No se encontró el archivo en la base de datos";  }?> </td>
                                                <td width="70%" class="p-2 md:border md:border-grey-500 text-left block md:table-cell">
                                                    <span class="inline-block w-1/3 md:hidden font-bold">Acción</span>
                                            ...
                                            ?>
                                            <tr class="bg-gray-300 border border-grey-500 md:border-none block md:table-row">
                                                <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span class="inline-block w-full md:hidden font-bold">id</span>13</td>
                                                <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span class="inline-block w-full md:hidden font-bold">Nombre</span>Contrato nomina bancaria</td>
                                                <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span class="inline-block w-full md:hidden font-bold">Descarga</span><?php if($array3[$contador_array3]['nombre_archivo'] != null){ ?><a class='text-blue-600 hover:border-b-2 hover:border-blue-600' download='pdfTitle' href='<?php if($array3[$contador_array3]['nombre_archivo'] != null){ echo $array3[$contador_array3]['archivo']; }else { echo '#';} ?>' title='Download pdf document'><?php echo $array3[$contador_array3]['nombre_archivo']; ?></a><?php }else{ echo "No se encontró el archivo en la base de datos";  }?> </td>
                                                <td width="70%" class="p-2 md:border md:border-grey-500 text-left block md:table-cell">
                                                    <span class="inline-block w-1/3 md:hidden font-bold">Acción</span>
