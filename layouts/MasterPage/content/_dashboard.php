<div class="container mx-auto px-6 py-8">
    ...
    <div class="mt-4">
        <div class="bg-white overflow-hidden shadow-xl rounded-lg" style="background-image: url(https://bootdey.com/img/Content/bg1.jpg); background-size: cover; background-position:center; background-repeat:no-repeat;">
            <div class="container flex flex-col sm:flex-row sm:flex-wrap sm:text-left text-center items-center justify-center">
                ...
                <div class="text flex flex-col flex-grow text-white py-0 px-15">
                    <h1>Alberto Gerardo Martínez Guerrero</h1>
                    <p>Gerente</p>
                </div>
