                    ...
                    <div class="w-full">
                        <div class="bg-gray-50 shadow-md rounded-t">
                            <div class="container flex flex-col sm:flex-row items-center px-6 py-4 mx-auto overflow-y-auto whitespace-nowrap">
                                ...
                                <a href="permisos.php" class="flex items-center text-blue-600 -px-2 hover:underline">
                                    <svg class="w-6 h-6 mx-2" viewBox="0 0 24 24">
                        ...
                        <div class="bg-white p-3 shadow-md rounded-b">
                            ...
                            <thead>
                                    <tr class="bg-black text-white uppercase text-sm leading-normal" style="font-size: 13px !important;  background-color: #000000bd !important;; !important;">
                                        <th class="py-3 border-white dt-tituloL text-left all">Permiso</th>
                                        <th class="py-3 border-white text-left min-tablet">Categoria</th>
                        ...
                        <div class="modal-content text-center w-full mt-3 sm:mt-0 sm:text-left">
                            <div class="grid grid-cols-1 mt-5 mx-6 px-3">
                                ...
                                <div class="group flex">
                                    ...
                                    <input class="w-full -ml-10 pl-10 py-2 px-3 rounded-lg border-2 border-celeste-600 mt-1 focus:outline-none focus:ring-2 focus:ring-celeste-800 focus:border-transparent" type="text" id="crearpermiso" name="crearpermiso" placeholder="Nombre permiso">
                                </div>
                            </div>
                            <div class="grid grid-cols-1 mt-5 mx-6 px-3">
