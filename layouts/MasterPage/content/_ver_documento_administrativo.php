            ...
            <div class="bg-white p-3 shadow-md rounded-b">
                    ...
                    <div class="grid grid-cols-1 mt-1 mx-7">
                      <div class="group flex items-center justify-end gap-3">
                        ...
                        <svg class="shrink-0 w-5 h-5 text-gray-700" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                          <path fill="currentColor" d="M20,8L12,13L4,8V6L12,11L20,6M20,4H4C2.89,4 2,4.89 2,6V18A2,2 0 0,0 4,20H20A2,2 0 0,0 22,18V6C22,4.89 21.1,4 20,4Z" /></svg></span>
                      </div>
                    </div>
                    <div class="grid grid-cols-1 mt-1 mx-7">
                      <div class="group flex items-center justify-end gap-3">
                        ...
                        <svg class="shrink-0 w-5 h-5 text-gray-700" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                          <path fill="currentColor" d="M12,11.5A2.5,2.5 0 0,1 9.5,9A2.5,2.5 0 0,1 12,6.5A2.5,2.5 0 0,1 14.5,9A2.5,2.5 0 0,1 12,11.5M12,2A7,7 0 0,0 5,9C5,14.25 12,22 12,22C12,22 19,14.25 19,9A7,7 0 0,0 12,2Z" /></svg>
                      </div>
                    </div>
                    <div class="grid grid-cols-1 mt-1 mx-7">
                      <div class="group flex items-center justify-end gap-3">
              ...
              <?php }else{ ?>
                <div id="main_carta" class="mt-5 mx-7 p-2" style="border: 5px solid black;">
                  <div id="information_carta" style="word-break:break-word;">
                    <div class="grid grid-cols-1 mx-7 text-right">
                      <span class= "font-semibold">Guadalupe Nuevo León, <?php echo $fetch_information -> fecha; ?></span>
                    </div>
                  </div>
                  <div class="grid grid-cols-1 mt-5">
              ...
              <div class="grid grid-cols-1 mx-7 mt-5">
                <div class="text-center md:text-right">	
                  <button type="button" id="print" name="print" class="button bg-indigo-600 text-white rounded-md h-11 px-8 py-2 focus:ring-2 focus:outline-none focus:ring-[#4F46E5]/50 hover:bg-indigo-500 active:bg-indigo-700">Imprimir</button>
                </div>
              </div>
            </div>
          </div>
