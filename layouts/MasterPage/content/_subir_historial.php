                    ...
                    <div class="w-full">
                        <div class="bg-gray-50 shadow-md rounded-t">
                            <div class="container flex flex-col sm:flex-row items-center px-6 py-4 mx-auto overflow-y-auto whitespace-nowrap">
                                ...
                                <a href="historial_vacaciones.php" class="inline-flex items-center text-sm font-medium text-gray-700 focus:outline-none focus:text-[#27ceeb] hover:text-[#27ceeb]">
                                    <svg class="w-5 h-5 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                ...
                                <div class="flex items-center text-gray-400">
                                    ...
                                    <span class="text-sm font-medium">Subir vacaciones al historial</span>
                                </div>
                            </div>
                        </div>
                        <div class="bg-white p-3 shadow-md rounded-b">
                            <div class="flex flex-col mt-5 mx-7">
                                <h2 class="text-2xl text-[#64748b] font-semibold">Formulario para registrar solicitudes de vacaciones manualmente</h2>
                                <span class="text-[#64748b]">Por favor, proporciona todos los datos necesarios para poder registrar una solicitud de vacaciones.</span>
                            ...
                            <form id="Guardar">
                                ...
                                <div class="grid grid-cols-1 mt-5 mx-7">
                                    ...
                                    <div class="group flex">
                                        ...
                                        <input class="w-full -ml-10 pl-10 py-2 h-11 border rounded-md border-[#d1d5db] focus:ring-2 focus:ring-celeste-600" type="text" id="periodo_vacaciones" name="periodo_vacaciones" placeholder="Periodo de las vacaciones" autocomplete="off">
                                    </div>
                                </div>
                                <div class="grid grid-cols-1 mt-5 mx-7">
                                    <label class="text-[#64748b] font-semibold mb-2">
                                    ...
                                    <div class="group flex">
                                        ...
                                        <input class="w-full -ml-10 pl-10 py-2 h-11 border rounded-md border-[#d1d5db] focus:ring-2 focus:ring-celeste-600" type="text" id="fecha_vacaciones" name="fecha_vacaciones" placeholder="¿En qué fecha fue expedida la solicitud?" autocomplete="off">
                                    </div>
                                </div>
                                <div class="grid grid-cols-1 mt-5 mx-7">
