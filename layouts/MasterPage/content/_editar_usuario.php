              ...
              <div class='flex items-center justify-center w-full'>
                <label class='flex flex-col border-4 border-dashed w-full h-32 hover:bg-gray-100 hover:border-black group'>
                  <div class='flex flex-col items-center justify-center pt-7'>
                    ...
                    <p id="archivo" class='lowercase text-sm text-gray-400 group-hover:text-black pt-1 tracking-wider'><?php if($row->foto ==null){ echo "Selecciona una fotografía"; }else{ echo $row->nombre_foto;} ?></p>
                  </div>
