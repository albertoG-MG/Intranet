          ...
          <form id="Guardar" method="post">
            ...
            <div class="grid grid-cols-1 mt-5 mx-7">
              ...
              <div class="group flex">
                ...
                <input class="w-full -ml-10 pl-10 py-2 px-3 rounded-lg border-2 border-indigo-600 mt-1 focus:outline-none focus:ring-2 focus:ring-indigo-800 focus:border-transparent" type="password" id="password" name="password" value="<?php echo "{$row->password}"; ?>" placeholder="************">
              </div>
            </div>
            ...
            <div class="grid grid-cols-1 mt-5 mx-7">
              ...
              <div class="group flex">
                <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-lock-outline text-gray-400 text-lg"></i></div>
                <input class="w-full -ml-10 pl-10 py-2 px-3 rounded-lg border-2 border-indigo-600 mt-1 focus:outline-none focus:ring-2 focus:ring-indigo-800 focus:border-transparent" type="password" id="cpassword" name="cpassword" value="<?php echo "{$row->password}"; ?>" placeholder="************">
              </div>
            </div>
            ...
            <div class="grid grid-cols-1 mt-5 mx-7">
              ...
              <div class="group flex">
                ...
                echo "<option value='".$dp->id."'"; if($row->departamento_id==$dp->id) echo 'selected="selected"'; echo">";
              ...
              <div class='flex items-center justify-center w-full'>
                <label class='flex flex-col border-4 border-dashed w-full h-32 hover:bg-gray-100 hover:border-indigo-800 group'>
                  <div class='flex flex-col items-center justify-center pt-7'>
                    <div id="svg">
                      <?php if($row->foto == null && $row->nombre_foto == null){ ?>
                      ...
                      <?php }else{ ?>
                        <img class="w-10 h-10" <?php echo "src={$row -> foto}"; ?> />
                      <?php } ?>
                    </div>
                    <img id="preview" class="hidden" />
                    <p id="archivo" class='lowercase text-sm text-gray-400 group-hover:text-indigo-800 pt-1 tracking-wider'><?php if($row->foto ==null){ echo "Selecciona una fotografía"; }else{ echo $row->nombre_foto;} ?></p>
                  </div>
