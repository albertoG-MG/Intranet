               ...
               <div class="w-full">
                  ...
                  <div class="bg-white p-3 shadow-md rounded-b">
                     <div class="flex flex-col mt-5 mx-7">
                        ...
                        <span class="text-[#64748b]">Por favor, proporciona todas las modificaciones necesarias.</span>
                     ...
                     <form id="Guardar" method="post">
                        <div class="grid grid-cols-1 mt-5 mx-7">
                           ...
                           <div class="group flex">
                              ...
                              <input class="w-full -ml-10 pl-10 py-2 h-11 border rounded-md border-[#d1d5db] focus:ring-2 focus:ring-celeste-600" type="text" aria-describedby="usuario_help" id="usuario" name="usuario" placeholder="i.e. Juan.Garcia" value="<?php echo "{$row->username}"; ?>">
                           </div>
                        ...
                        <div class="grid grid-cols-1 mt-5 mx-7">
                           ...
                           <div class="group flex">
                              ...
                              <input class="w-full -ml-10 pl-10 py-2 h-11 border rounded-md border-[#d1d5db] focus:ring-2 focus:ring-celeste-600" type="text" id="nombre" name="nombre" placeholder="i.e. José Juan" aria-describedby="nombre_help" value="<?php echo "{$row->nombre}"; ?>">
                           </div>
                        ...
                        <div class="grid grid-cols-1 mt-5 mx-7">
                           ...
                           <div class="group flex">
                              ...
                              <input class="w-full -ml-10 pl-10 py-2 h-11 border rounded-md border-[#d1d5db] focus:ring-2 focus:ring-celeste-600" type="text" id="apellido_pat" name="apellido_pat" placeholder="i.e. Caballero-Plasencia" aria-describedby="apellido_pat_help" value="<?php echo "{$row->apellido_pat}"; ?>">
                           </div>
                        ...
                        <div class="grid grid-cols-1 mt-5 mx-7">
                           ...
                           <div class="group flex">
                              ...
                              <input class="w-full -ml-10 pl-10 py-2 h-11 border rounded-md border-[#d1d5db] focus:ring-2 focus:ring-celeste-600" type="text" id="apellido_mat" name="apellido_mat" placeholder="i.e. Plasencia'Ramírez" aria-describedby="apellido_mat_help" value="<?php echo "{$row->apellido_mat}"; ?>">
                           </div>
                        ...
                        <div class="grid grid-cols-1 mt-5 mx-7">
                           ...
                           <div class="group flex">
                              ...
                              <input class="w-full -ml-10 pl-10 py-2 h-11 border rounded-md border-[#d1d5db] focus:ring-2 focus:ring-celeste-600" type="text" id="correo" name="correo" placeholder="i.e. example@example.com" value="<?php echo "{$row->correo}"; ?>">
                           </div>
