                                                   ...
                                                   <div x-show="combo_reflabrelacion2">
                                                      <div class="grid grid-cols-1">   
                                                         ...
                                                         <div class="group flex">
                                                            ...
                                                            <select class="w-full -ml-10 pl-10 py-2 h-11 border rounded-md border-[#d1d5db] focus:ring-2 focus:ring-celeste-600" x-on:change="if($el.value == 'OTRO'){text_reflabrelacion2 = true; combo_reflabrelacion2 = false;}else if($el.value != 'OTRO'){text_reflabrelacion2 = false; combo_reflabrelacion2 = true;}" id="infb_rrelacion2" name="infb_rrelacion2">
                                                   ...
                                                   <div x-show="combo_reflabrelacion3">
                                                      <div class="grid grid-cols-1">   
                                                         ...
                                                         <div class="group flex">
                                                            ...
                                                            <select class="w-full -ml-10 pl-10 py-2 h-11 border rounded-md border-[#d1d5db] focus:ring-2 focus:ring-celeste-600" x-on:change="if($el.value == 'OTRO'){text_reflabrelacion3 = true; combo_reflabrelacion3 = false;}else if($el.value != 'OTRO'){text_reflabrelacion3 = false; combo_reflabrelacion3 = true;}" id="infb_rrelacion3" name="infb_rrelacion3">
