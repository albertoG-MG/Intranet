                    ...
                    <div class="w-full">
                        ...
                        <div class="bg-white p-3 shadow-md rounded-b">
                            ...
                            <div id="DT-div" style="display:none;">
                                ...
                                <thead>
                                        <tr class="text-white uppercase text-sm leading-normal" style="font-size: 12px !important; background-color: #000000bd !important;">
                                        <th class="py-3  border-white dt-tituloL text-left desktop">creada por</th>
                                            <th class="py-3  border-white text-left all">asignada a</th>
                                            <th class="py-3  border-white text-center desktop">tipo</th>
                                            <th class="py-3  border-white text-center desktop">fecha</th>
                                            <th class="py-3  border-white text-center desktop">documento</th>
                                            <th class="py-3  border-white text-center desktop">documento</th>
                                            <th class="py-3  border-white dt-tituloR text-center min-tablet">acción</th>
                                            <th class="py-3  border-white dt-tituloR text-center min-tablet">acción</th>
                                            <th></th>
                                        </tr>
                                    </thead>
