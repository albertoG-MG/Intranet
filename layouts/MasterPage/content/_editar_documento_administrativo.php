                            ...
                            <form id="editar-documento" method="POST">
                                ...
                                <div class="grid grid-cols-1 mt-5 mx-7">
                                    ...
                                    <div class="group flex">
                                        ...
                                        <input class="w-full -ml-10 pl-10 py-2 h-11 border rounded-md border-[#d1d5db] focus:ring-2 focus:ring-celeste-600" type="text" id="fecha_acta" name="fecha_acta" placeholder="Editar la fecha de expedición del acta administrativa" autocomplete="off">
                                    </div>
                                </div>
                                <div class="grid grid-cols-1 mt-5 mx-7">
                                ...
                                <div class="grid grid-cols-1 mt-5 mx-7">
                                    ...
                                    <textarea class="w-full py-2 h-20 border rounded-md border-[#d1d5db] focus:ring-2 focus:ring-celeste-600" id="motivo_acta" name="motivo_acta" placeholder="Editar el motivo por el que se realiza el acta"><?php echo $fetch_information -> motivo_acta; ?></textarea>
                                    <div id="error_motivo_acta"></div>
                                </div>
                                <div class="grid grid-cols-1 mt-5 mx-7">
                                    <label class="text-[#64748b] font-semibold mb-2">Editar las observaciones y/o Comentarios</label>
                                    <textarea class="w-full py-2 h-20 border rounded-md border-[#d1d5db] focus:ring-2 focus:ring-celeste-600" id="obcomen_acta" name="obcomen_acta" placeholder="Editar las observaciones y/o Comentarios"><?php echo $fetch_information -> observaciones_acta; ?></textarea>
                                ...
                                <div class="flex flex-col-reverse items-center gap-3 md:flex-row md:justify-end md:space-x-2 mx-7 mt-5">
                                    <div id="submit-edit-acta">
                                        <button type="submit" id="boton-editar-acta" name="boton-editar-acta" class="button btn-celeste text-white rounded-md h-11 px-8 py-2 focus:ring-2 focus:outline-none focus:ring-[#27ceeb]/50 hover:bg-celeste-500 active:bg-celeste-700">Editar acta</button>
                                    </div>
                                </div
                                <?php }else if($fetch_information -> tipo == "CARTA COMPROMISO"){ ?>
                                    <div class="grid grid-cols-1 mt-5 mx-7">
                                        ...
                                        <div class="group flex">
                                            ...
                                            <input class="w-full -ml-10 pl-10 py-2 h-11 border rounded-md border-[#d1d5db] focus:ring-2 focus:ring-celeste-600" type="text" id="fecha_carta" name="fecha_carta" placeholder="Editar la fecha de expedición de la carta compromiso" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="grid grid-cols-1 mt-5 mx-7">
                                        <label class="text-[#64748b] font-semibold mb-2">
                                    ...
                                    <div class="grid grid-cols-1 mt-5 mx-7">
                                        ...
                                        <textarea class="w-full py-2 h-20 border rounded-md border-[#d1d5db] focus:ring-2 focus:ring-celeste-600" id="responsabilidad_carta" name="responsabilidad_carta" placeholder="Editar responsabilidades a cumplir"><?php echo $fetch_information -> responsabilidades_carta; ?></textarea>
                                        <div id="error_responsabilidad_carta"></div>
                                    </div>
                                    <div class="mt-12 h-px bg-slate-200"></div>
                                    <div class="flex flex-col-reverse items-center gap-3 md:flex-row md:justify-end md:space-x-2 mx-7 mt-5">
                                        <div id="submit-edit-carta">
                                            <button type="submit" id="boton-editar-carta" name="boton-editar-carta" class="button btn-celeste text-white rounded-md h-11 px-8 py-2 focus:ring-2 focus:outline-none focus:ring-[#27ceeb]/50 hover:bg-celeste-500 active:bg-celeste-700">Editar carta</button>
                                        </div>
                                    </div>
                                <?php } ?>
                            </form>
