...
.Titulos{
    ...
    <div class="container mx-auto my-2 p-5"  style="inset -4px 2px 20px 0px #c1c1c1 !important;">
        ...
        <div class="flex flex-col mt-8">  
            ...
            <div class="md:flex no-wrap md:-mx-2 ">
                <div class="w-full md:w-3/12 md:mx-2">
                    <div class="bg-white shadow-md rounded-lg p-3" style="width: 95%">
                    ...
                    <div class="my-4"></div>
                    <div class="bg-white shadow-md rounded-t-lg md:rounded-lg p-3 hover:shadow" style="width: 95%">
                        ...
                        <div class="grid grid-cols-1" style="word-break:break-word;">
                            ...
                            <?php if($countexpediente > 0){ ?>
                                <?php if($fetch_information -> esituacion_del_empleado == "ALTA" && $fetch_information -> eestatus_del_empleado == "NUEVO INGRESO" || $fetch_information -> esituacion_del_empleado == "ALTA" && $fetch_information -> eestatus_del_empleado == "REINGRESO"){ ?>
                                    <span id="vacaciones_disponibles" class="px-4 py-2"><?php echo $vacaciones_dias. " días"; ?></span>
                                <?php }else{ ?>
                ...
                <div class="w-full md:w-9/12 h-64">
                        ...
                        <div class="bg-white p-3 shadow-md rounded-b-lg md:rounded-lg">
                            ...
                            <div class="grid grid-cols-1 mt-5 text-center">
                                <div id="submit-vacaciones">
                                    <button class="button btn-celeste text-white rounded-md h-11 px-8 py-2 focus:ring-2 focus:outline-none active:bg-celeste-700" id="guardar_general" name="guardar_general" type="submit">
                    ...
                    <div class="bg-white p-3 shadow-md rounded-lg">
                        <div class="flex items-center space-x-3 font-semibold text-gray-900 text-xl leading-8" style="margin-bottom: -1.25rem !important;">
                        ...
                        <div id="DT-div" style="display:none;">
                            <table class="w-full" id="datatable">
                                <thead>
                                    <tr class="bg-white text-white uppercase text-sm leading-normal" style="font-size: 13px !important; background-color: #000000bd !important;">
                                        <th>Solicitud_id</th>
                                        <th class="py-3 text-center all">Nombre</th>
...
<?php if((Roles::FetchSessionRol($_SESSION["rol"]) == "Superadministrador" || Roles::FetchSessionRol($_SESSION["rol"]) == "Administrador") || (Permissions::CheckPermissions($_SESSION["id"], "Ver todas las vacaciones") == "true" && Permissions::CheckPermissions($_SESSION["id"], "Editar estatus de las vacaciones") == "true")){ ?>
	<div id="modal-component-container" class="contenedor modal-component-container hidden fixed inset-0" style="z-index:100;">
