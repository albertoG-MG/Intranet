...
<nav class="mt-10">
    ...
    <button class="flex w-full items-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100" data-collapse-toggle="catalogos">
    ...
    <ul id="catalogos" class="hidden py-2 space-y-2">
        <li>
            <a href="#" class="flex items-center p-2 pl-11 w-full transition duration-75 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100"><p class="ml-4">Products</p></a>
        </li>
    </ul>
