...
<nav class="mt-10">
	...
	<?php if(basename($_SERVER['PHP_SELF']) == 'vacaciones.php' || basename($_SERVER['PHP_SELF']) == 'solicitud_vacaciones.php' || basename($_SERVER['PHP_SELF']) == 'historial_vacaciones.php' || basename($_SERVER['PHP_SELF']) == 'subir_historial.php'){?>
