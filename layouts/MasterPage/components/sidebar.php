...
<nav class="mt-10">
    ...
    <?php if(basename($_SERVER['PHP_SELF']) == 'incidencias.php' || basename($_SERVER['PHP_SELF']) == 'crear_incidencia.php' || basename($_SERVER['PHP_SELF']) == 'editar_incidencia.php' || basename($_SERVER['PHP_SELF']) == 'ver_incidencia.php'){?>
