...
<script>
    ...
    //delete switch array para borrar las papelerías
	...
	$(document).ready(function() {
        ...
        var fechaEstatus = "<?php echo is_null($edit->eestatus_fecha) ? '' : $edit->eestatus_fecha ?>";

        $('input[name="fecha_estatus"]').daterangepicker({ showDropdowns: true, parentEl: "main", singleDatePicker: true, "locale": { "format": "YYYY/MM/DD", "applyLabel": "Aceptar", "cancelLabel": "Cancelar", "daysOfWeek": ["Dom","Lun", "Mar", "Mie", "Jue", "Vie", "Sab"], "monthNames": ["Ene", "Feb", "Mar", "Abr", "May", "Jun", "Jul", "Ago", "Sep", "Oct", "Nov", "Dic"]}, applyButtonClasses: "button btn-celeste px-3 py-3 text-white rounded-md focus:ring-2 focus:outline-none focus:ring-[#27ceeb]/50 hover:bg-celeste-500 active:bg-celeste-700", cancelClass: "button bg-white border border-gray-300 text-gray-600 rounded-md outline-none px-3 py-3 focus:ring-2 focus:outline-none focus:ring-[#d1d5db]/50 hover:bg-gray-50 active:bg-gray-100" });
        $('input[name="fechanac"]').daterangepicker({ showDropdowns: true, parentEl: "main", singleDatePicker: true, "startDate": dt, "locale": { "format": "YYYY/MM/DD", "applyLabel": "Aceptar", "cancelLabel": "Cancelar", "daysOfWeek": ["Dom","Lun", "Mar", "Mie", "Jue", "Vie", "Sab"], "monthNames": ["Ene", "Feb", "Mar", "Abr", "May", "Jun", "Jul", "Ago", "Sep", "Oct", "Nov", "Dic"]}, applyButtonClasses: "button btn-celeste px-3 py-3 text-white rounded-md focus:ring-2 focus:outline-none focus:ring-[#27ceeb]/50 hover:bg-celeste-500 active:bg-celeste-700", cancelClass: "button bg-white border border-gray-300 text-gray-600 rounded-md outline-none px-3 py-3 focus:ring-2 focus:outline-none focus:ring-[#d1d5db]/50 hover:bg-gray-50 active:bg-gray-100" });
        ...
        $('input[name="fecha_estatus"]').val(fechaEstatus);
        ...
        echo (" $('#upload-button{$papeleria_archivo['id']}').on('click', function () {
                ...
                delete_switch_array[{$papeleria_archivo['id']}] = 'false';
                ...
                $('#upload-delete{$papeleria_archivo['id']}').on('click', function () {
                    ...
                    $('#upload-delete{$papeleria_archivo['id']}').addClass('hidden');
                    $('#upload-delete{$papeleria_archivo['id']}').removeClass('z-100 md:p-2 my-auto');
                    delete_switch_array[{$papeleria_archivo['id']}]='true';
                });
        ...
        if($('#situacion').val() == ""){
            $('#estatus_empleado').html(
                "<option value=\"\" <?php if($edit -> eestatus_del_empleado == ""){ echo "selected";} ?>>SIN ESTATUS</option>");
        }else if ($('#situacion').val() == "ALTA") {
            $('#estatus_empleado').html(
        ...
        <?php }else if($edit -> eestatus_del_empleado == ""){ ?>
    ...
    function DatosG(){
        ...
        var numero_baja = $('#numero_baja').val();
        var fijo_mensual = $('#fijo_mensual').val();
        var tipo_esquema = $('#esquema_pago').val();
        ...
        fd.append('numero_baja', numero_baja);
        fd.append('fijo_mensual', fijo_mensual);
        fd.append('tipo_esquema', tipo_esquema);
        ...
        $.ajax({
            ...
            success: function (response) {
                setTimeout(function(){
                    ...
                    }else if (array[0] == "expediente_deleted") {
                        Swal.fire({
                            title: "Error",
                            text: array[1],
                            icon: "error"
