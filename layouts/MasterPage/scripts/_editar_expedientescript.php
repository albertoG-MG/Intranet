    ...
    $(document).ready(function () {
        ...
        if ($('#refban').val() != "") {
            ...
            for (i = 0; i < number; i++) {
               ...
               divicon.classList.add('w-10', 'z-10', 'pl-1', 'text-center', 'pointer-events-none', 'flex', 'items-center', 'justify-center');
               var icon = document.createElement("i");
               icon.classList.add('mdi', 'mdi-account', 'text-gray-400', 'text-lg');
               divicon.appendChild(icon);
               grupo.appendChild(divicon);
               var input = document.createElement("input");
               input.type = "text";
               input.value = miArr[y];
               y++;
               ...
               divicon2.classList.add('w-10', 'z-10', 'pl-1', 'text-center', 'pointer-events-none', 'flex', 'items-center', 'justify-center');
               var icon2 = document.createElement("i");
               icon2.classList.add('mdi', 'mdi-account-group', 'text-gray-400', 'text-lg');
               divicon2.appendChild(icon2);
               grupo2.appendChild(divicon2);		   
               var input2 = document.createElement("input");
               input2.type = "text";
               input2.value = miArr[y];
               y++;
               ...
               divicon3.classList.add('w-10', 'z-10', 'pl-1', 'text-center', 'pointer-events-none', 'flex', 'items-center', 'justify-center');
               var icon3 = document.createElement("i");
               icon3.classList.add('mdi', 'mdi-file-document-edit-outline', 'text-gray-400', 'text-lg');
               divicon3.appendChild(icon3);
               grupo3.appendChild(divicon3);	   
               var input3 = document.createElement("input");
               input3.type = "text";
               input3.value = miArr[y];
               y++;
               ...
               divr1.appendChild(grupo4);
			   var divicon4 = document.createElement("div");
               divicon4.classList.add('w-10', 'z-10', 'pl-1', 'text-center', 'pointer-events-none', 'flex', 'items-center', 'justify-center');
               var icon4 = document.createElement("i");
               icon4.classList.add('mdi', 'mdi-format-list-numbered', 'text-gray-400', 'text-lg');
               divicon4.appendChild(icon4);
               grupo4.appendChild(divicon4);
               var input4 = document.createElement("input");
               input4.type = "text";
               input4.value = miArr[y];
               y++;
               ...
               divr2.appendChild(grupo5); 
			   var divicon5 = document.createElement("div");
               divicon5.classList.add('w-10', 'z-10', 'pl-1', 'text-center', 'pointer-events-none', 'flex', 'items-center', 'justify-center');
               var icon5 = document.createElement("i");
               icon5.classList.add('mdi', 'mdi-percent-box', 'text-gray-400', 'text-lg');
               divicon5.appendChild(icon5);
               grupo5.appendChild(divicon5);	   
               var input5 = document.createElement("input");
               input5.type = "text";
               input5.value = miArr[y];
               y++;
