...
<style>
    ...
    .dt-button.buttons-copy.buttons-html5{
        ...
        background-color: rgb(255 145 25 / var(--tw-bg-opacity)) !important;
        color:white;
        border-radius: 0.375rem !important;
    }

    .dt-button.buttons-copy.buttons-html5:focus{
        --tw-ring-offset-shadow: var(--tw-ring-inset) 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color) !important;
        --tw-ring-shadow: var(--tw-ring-inset) 0 0 0 calc(2px + var(--tw-ring-offset-width)) var(--tw-ring-color) !important;
        box-shadow: var(--tw-ring-offset-shadow), var(--tw-ring-shadow), var(--tw-shadow, 0 0 #0000) !important;
        outline: 2px solid transparent !important;
        outline-offset: 2px !important;
        --tw-ring-color: rgb(255 145 25 / 0.5) !important;
    }

    .dt-button.buttons-copy.buttons-html5:hover{
        background-color: rgb(255 145 25 / 0.6) !important;
    }

    .dt-button.buttons-copy.buttons-html5:active{
        background-color: rgb(255 145 25 / 0.7) !important;
    }
    
    button.buttons-copy{
        background:rgb(79 70 229 / var(--tw-border-opacity)) !important;
    }
