                    ...
                    render: function (data, type, row) {
                        return (
                            "<div class='flex item-center justify-start md:justify-center gap-3'>" +
                                ...
                                "<div class='w-4 transform hover:text-orange-500 hover:scale-110 cursor-pointer Ver'>" +
                                ...
                                ?>
                                "<div class='w-4 transform hover:text-orange-500 hover:scale-110 cursor-pointer Editar'>" +
                                    "<svg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 24 24' stroke='currentColor'>" +
                                ...
                                ?>
                                "<div class='w-4 transform hover:text-orange-500 hover:scale-110 cursor-pointer Eliminar'>" +
                                    "<svg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 24 24' stroke='currentColor'>" +
