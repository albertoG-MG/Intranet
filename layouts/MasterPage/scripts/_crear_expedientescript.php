        ...
        if($('#Guardar').length > 0 ){
            $('#Guardar').validate({
                ...
                submitHandler: function(form) {
                    $('#submit-button').html(
		                '<button disabled type="submit" id="finish" name="finish" class="button bg-indigo-600 hover:bg-indigo-500 active:bg-indigo-700 text-white rounded-md h-11 px-8 py-2">'+
