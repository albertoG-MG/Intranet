<script>
    ...
    $(document).ready(function () {
        ...
        <?php if($fetch_token_user->exp_date >= $curDate){ ?>
            ...
            <?php 
                while($papeleria_contador2 < $counttipospapeleria){
                    echo ("var papeleria_clone{$array_papeleria[$papeleria_contador2]['id']};");

                    echo (" $('#upload-button{$array_papeleria[$papeleria_contador2]['id']}').on('click', function () {
                                $('#infp_papeleria{$array_papeleria[$papeleria_contador2]['id']}').click();
                            });
                            
                            delete_switch_array.push('false');

                            $('#infp_papeleria{$array_papeleria[$papeleria_contador2]['id']}').on('click', function () {
                                papeleria_clone{$array_papeleria[$papeleria_contador2]['id']} = $('#infp_papeleria{$array_papeleria[$papeleria_contador2]['id']}').clone();
                            });

                            $('#infp_papeleria{$array_papeleria[$papeleria_contador2]['id']}').on('change', function () {
                                if (window.FileReader && window.Blob) {
                                    var files = $('#infp_papeleria{$array_papeleria[$papeleria_contador2]['id']}').get(0).files;
                                    if (files.length > 0) {
                                        var file = files[0];
                                        ...
                                        $('#upload-text{$array_papeleria[$papeleria_contador2]['id']}').html('');
                                        $('#upload-text{$array_papeleria[$papeleria_contador2]['id']}').html(files.length+ ' archivo seleccionado');
                                        ...
                                        $('#content-container{$array_papeleria[$papeleria_contador2]['id']}').addClass('grid grid-cols-1');
                                        $('#upload-delete{$array_papeleria[$papeleria_contador2]['id']}').addClass('z-100 md:p-2 my-auto');
                                        $('#upload-delete{$array_papeleria[$papeleria_contador2]['id']}').removeClass('hidden');
                                        var ul = $('<ul id=\'lista{$array_papeleria[$papeleria_contador2]['id']}\' class=\'break-all md:break-normal\'></ul>');
                                        $('#content-container{$array_papeleria[$papeleria_contador2]['id']}').append(ul);
                                        ...
                                        $('#infp_papeleria{$array_papeleria[$papeleria_contador2]['id']}').replaceWith(papeleria_clone{$array_papeleria[$papeleria_contador2]['id']}.clone());
                                    }
                                } else {
                                    console.error('FileReader ó Blob no es compatible con este navegador.');
                                    if(!($('#infp_papeleria{$array_papeleria[$papeleria_contador2]['id']}').get(0).files.length === 0)){
                                        var documento = $('#infp_papeleria{$array_papeleria[$papeleria_contador2]['id']}').prop('files');
                                        $('#upload-text{$array_papeleria[$papeleria_contador2]['id']}').html('');
                                        $('#upload-text{$array_papeleria[$papeleria_contador2]['id']}').html(documento.length+ ' archivo seleccionado');
                                        $('#content-container{$array_papeleria[$papeleria_contador2]['id']}').html('');
                                        $('#content-container{$array_papeleria[$papeleria_contador2]['id']}').removeClass('grid grid-cols-1');
                                        $('#content-container{$array_papeleria[$papeleria_contador2]['id']}').addClass('grid grid-cols-1');
                                        $('#upload-delete{$array_papeleria[$papeleria_contador2]['id']}').addClass('z-100 md:p-2 my-auto');
                            ...
                            $('#upload-delete{$array_papeleria[$papeleria_contador2]['id']}').on('click', function () {
                                $('#content-container{$array_papeleria[$papeleria_contador2]['id']}').html('');
                                $('#content-container{$array_papeleria[$papeleria_contador2]['id']}').removeClass('grid grid-cols-1');
                                $('#infp_papeleria{$array_papeleria[$papeleria_contador2]['id']}').val('');
                                $('#upload-text{$array_papeleria[$papeleria_contador2]['id']}').html('No hay ningún archivo seleccionado');
                                $('#upload-delete{$array_papeleria[$papeleria_contador2]['id']}').addClass('hidden');
                                $('#upload-delete{$array_papeleria[$papeleria_contador2]['id']}').removeClass('z-100 md:p-2 my-auto');
                                delete_switch_array[{$array_papeleria[$papeleria_contador2]['id']}-1]='true';	
                            });
