<?php
    ...
    if (Permissions::CheckPermissions($_SESSION["id"], "Acceso a usuarios") == "false" && Roles::FetchSessionRol($_SESSION["rol"]) != "Superadministrador" && Roles::FetchSessionRol($_SESSION["rol"]) != "Administrador") {
