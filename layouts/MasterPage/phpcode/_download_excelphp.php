<?php
    ...
    'CONTRATO SUPERVIVENCIA', 'SITUACION FISCAL', 'CARTA RESPONSIVA DE EQUIPOS ASIGNADOS', 'BAJA ANTE IMSS', 'MODIFICACION SALARIAL', 'COMPROBANTE DE ESTUDIOS', 'CARATULA DE DATOS BANCARIOS', 'ACTA DE MATRIMONIO');
