<?php
    ...
    if (Permissions::CheckPermissions($_SESSION["id"], "Crear subroles") == "false" && Roles::FetchSessionRol($_SESSION["rol"]) != "Superadministrador" && Roles::FetchSessionRol($_SESSION["rol"]) != "Administrador") {
