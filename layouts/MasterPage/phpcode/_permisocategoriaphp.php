<?php
    ...
    if (Permissions::CheckPermissions($_SESSION["id"], "Categorias") == "false" && Roles::FetchSessionRol($_SESSION["rol"]) != "Superadministrador" && Roles::FetchSessionRol($_SESSION["rol"]) != "Administrador") {
