      ...
      background-position: 0% 50%;
                ...
                <?php }else{  ?>
                    <div class="text-center">
                        ...
                        <a href="login.php" class="block w-full max-w-xs mx-auto btn-celeste hover:bg-celeste-700 focus:bg-celeste-700 text-white rounded-lg px-3 py-3 font-semibold cursor-pointer mt-5">Volver al login</a>
                    </div>
                <?php }  ?>
			</div>
		</div>
